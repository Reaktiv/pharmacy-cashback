...
class BroadcastSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        # Measure the exact string that will be sent (title rendered bold
        # above the body) — apps.broadcasts.tasks builds the same string,
        # so validation here and the real send can never disagree.
